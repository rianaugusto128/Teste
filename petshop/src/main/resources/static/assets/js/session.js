(function () {
    ...
    function cargoTemAcessoAdmin(cargo) {
        return !!(cargo && cargo.ativo !== false && (
            ...
            cargo.acessoUsuarios || cargo.acessoCargos || cargo.acessoEstoque
        ));
    }
    ...
    function buildLoggedMenu(sessao, isMobile) {
        ...
        const destinoPrincipal = podeAdmin ?'admin.html' : 'user.html';
        const rotuloPrincipal = podeAdmin ?'Painel admin' : 'Minha conta';
        return `
