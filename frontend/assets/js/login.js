...
function salvarSessao(data) {
    ...
    const cargoTemAcessoAdmin = sessao.cargo && (sessao.cargo.acessoProdutos || sessao.cargo.acessoCategorias || sessao.cargo.acessoPromocoes || sessao.cargo.acessoUsuarios || sessao.cargo.acessoCargos || sessao.cargo.acessoEstoque || sessao.cargo.acessoSuporte);
    if (sessao.perfil === 'ADMIN' || cargoTemAcessoAdmin) {
        ...
        if (sessao.cargo?.acessoSuporte && sessao.perfil !== 'ADMIN') return 'suporte-admin.html';
        return 'admin.html';
    }
